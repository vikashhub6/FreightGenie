...
exports.sendEmail = async (req, res) => {
  try {
    ...
    // Auto-generate Freight Invoice PDF
    try {
      const invPath = await generateFreightInvoice(shipment);
      shipment.freightInvoicePath = invPath;
      await shipment.save();
    } catch(invErr) { console.error("Invoice PDF error:", invErr.message); }
