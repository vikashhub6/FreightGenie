 ...
 */
class BaseLLM extends language_model_js_1.BaseLanguageModel {
    ...
    async *_streamIterator(input, options) {
        ...
        if (this._streamResponseChunks === BaseLLM.prototype._streamResponseChunks) {
            ...
            let generation = new output_js_1.GenerationChunk({
                text: "",
            });
            try {
    ...
    async predictMessages(messages, options, callbacks) {
        const text = (0, messages_js_1.getBufferString)(messages);
        const prediction = await this.call(text, options, callbacks);
        return new messages_js_1.AIMessage(prediction);
    }
    /**
