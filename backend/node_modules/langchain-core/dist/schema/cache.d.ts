import type { Generation } from "./output.js";
import { type StoredGeneration } from "./messages.js";
/**
...
export declare function deserializeStoredGeneration(storedGeneration: StoredGeneration): {
    text: string;
    message: import("./messages.js").ChatMessage | import("./messages.js").HumanMessage | import("./messages.js").AIMessage | import("./messages.js").SystemMessage | import("./messages.js").FunctionMessage | import("./messages.js").ToolMessage;
} | {
    text: string;
    message?: undefined;
};
