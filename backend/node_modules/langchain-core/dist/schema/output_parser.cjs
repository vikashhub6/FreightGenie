...
const index_js_2 = require("../util/@cfworker/json-schema/index.cjs");
/**
...
class BaseCumulativeTransformOutputParser extends BaseTransformOutputParser {
    ...
    async *_transform(inputGenerator) {
        ...
        for await (const chunk of inputGenerator) {
            ...
            let chunkGen;
            if ((0, messages_js_1.isBaseMessageChunk)(chunk)) {
                if (typeof chunk.content !== "string") {
                    throw new Error("Cannot handle non-string message output.");
                }
                chunkGen = new output_js_1.ChatGenerationChunk({
                    message: chunk,
                    text: chunk.content,
                });
            }
            else if ((0, messages_js_1.isBaseMessage)(chunk)) {
                if (typeof chunk.content !== "string") {
                    throw new Error("Cannot handle non-string message output.");
                }
                chunkGen = new output_js_1.ChatGenerationChunk({
                ...
                chunkGen = new output_js_1.GenerationChunk({ text: chunk });
            }
            if (accGen === undefined) {
                accGen = chunkGen;
            }
