...
export const downloadBookingPDFAPI = (shipmentId) =>
  api.get(`/shipment/${shipmentId}/download-booking`, { responseType: "blob" });

export const downloadInvoicePDFAPI = (shipmentId) =>
  api.get(`/shipment/${shipmentId}/download-invoice`, { responseType: "blob" });
